...
type Node struct {
	...
	// Confirmed by config Raft for this exact node identity, not local reachability.
	SubscriberProtocol uint32 `protobuf:"varint,12,opt,name=subscriberProtocol,proto3" json:"subscriberProtocol,omitempty"`
	unknownFields      protoimpl.UnknownFields
	sizeCache          protoimpl.SizeCache
}
...
func (x *Node) GetSubscriberProtocol() uint32 {
	if x != nil {
		return x.SubscriberProtocol
	}
	return 0
}
...
var file_pkg_cluster2_node_types_config_proto_rawDesc = []byte{
	...
	0x6c, 0x6f, 0x74, 0x73, 0x22, 0x8c, 0x03, 0x0a, 0x04, 0x4e, 0x6f, 0x64, 0x65, 0x12, 0x0e, 0x0a,
	...
	0x64, 0x41, 0x74, 0x12, 0x2e, 0x0a, 0x12, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65,
	0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x63, 0x6f, 0x6c, 0x18, 0x0c, 0x20, 0x01, 0x28, 0x0d, 0x52,
	0x12, 0x73, 0x75, 0x62, 0x73, 0x63, 0x72, 0x69, 0x62, 0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f,
	0x63, 0x6f, 0x6c, 0x22, 0x89, 0x02, 0x0a, 0x04, 0x53, 0x6c, 0x6f, 0x74, 0x12, 0x0e, 0x0a, 0x02,
